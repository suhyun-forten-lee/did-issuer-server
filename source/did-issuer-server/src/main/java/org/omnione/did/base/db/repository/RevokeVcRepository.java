...
public interface RevokeVcRepository extends JpaRepository<RevokeVc, Long> {
     ...
     * @return An Optional containing the RevokeVc if found, or an empty Optional if not found.
     */
    Optional<RevokeVc> findByTransactionId(Long transactionId);

    Optional<RevokeVc> findByVcId(String vcId);
}
