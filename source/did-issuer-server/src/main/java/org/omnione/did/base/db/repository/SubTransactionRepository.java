...
public interface SubTransactionRepository extends JpaRepository<SubTransaction, Long> {
    /**
     * Finds a SubTransaction entity by its associated transaction ID.
     *
     * @param transactionId The ID of the transaction to search for.
     * @return An Optional containing the SubTransaction if found, or an empty Optional if not found.
     */
