...
3. **Publishing the Integrated Release**  
   ...
   | ------------------ | --------------- | --------------------------- | --------------------------- |
   | did-ca-aos         | V1.0.1          | [Changelog](https://github.com/OmniOneID/did-issuer-server/blob/main/CHANGELOG.md) |
   | ..                 | ..              | ..                           |
